...
| `appointments` | Inline `_CustomerAppointmentsView` | Appointment APIs | Booking and visit-detail screens need feature extraction/visual redesign |
...
| referral/activity | No dedicated customer routes | Referral/activity domains exist in schema | Customer APIs and screens missing |
| `notifications` | Inline `_CustomerNotificationsView` | `GET /notifications` | Extract and add read/filter states |
