...
| `services`, `book-appointment` | Services and booking | Membership, providers, wellness products, appointments | Supported provider selection and customer-scoped booking |
