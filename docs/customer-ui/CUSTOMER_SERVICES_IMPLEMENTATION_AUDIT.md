...
Supported: active provider category/list/search/detail summary, pagination contract, wellness shop as a separate existing route, booking entry, prescription route, loading, empty, error/retry, and responsive scroll-safe filter chips.
