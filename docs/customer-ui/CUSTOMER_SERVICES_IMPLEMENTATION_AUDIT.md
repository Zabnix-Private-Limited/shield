...
Focused controller coverage proves that a direct route restoration reloads the selected provider type, trimmed query, and every recorded list page in order.
