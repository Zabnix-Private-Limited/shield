...
|---|---|---|---|---|---|
| Shared mobile header | All main customer routes | Browser capture attempted at 480×800; no project screenshot artifact because the local app rendered only a blank Flutter surface | Runtime log reported right overflow at 448px and vertical overflow after hot restarts | Header removes the brand lockup on dense widths and collapses wallet/reward controls to route-preserving icons below 480px; widget regression test passes at 480px and 448px | Authenticated device capture at 360/390/448px remains required; the separate vertical overflow needs a rendered route to identify its widget |
